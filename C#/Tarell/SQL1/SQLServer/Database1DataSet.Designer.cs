...
namespace SQLServer {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class PeopleDataTable : global::System.Data.TypedTableBase<PeopleRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PeopleRow AddPeopleRow(string Name, int Age, double Income) {
        ...
        public partial class PeopleRow : global::System.Data.DataRow {
            ...
            public double Income {
                get {
                    try {
                        return ((double)(this[this.tablePeople.IncomeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Income\' in table \'People\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablePeople.IncomeColumn] = value;
                }
            }
            ...
            public bool IsIncomeNull() {
                return this.IsNull(this.tablePeople.IncomeColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetIncomeNull() {
                this[this.tablePeople.IncomeColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace SQLServer.Database1DataSetTableAdapters {
    ...
    public partial class PeopleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[People] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Income = 1 AND [Income] IS NULL) OR ([Income] = @Original_Income)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[People] ([Name], [Age], [Income]) VALUES (@Name, @Age, @Income" +
                ");\r\nSELECT Id, Name, Age, Income FROM People WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[People] SET [Name] = @Name, [Age] = @Age, [Income] = @Income WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Income = 1 AND [Income] IS NULL) OR ([Income] = @Original_Income)));
SELECT Id, Name, Age, Income FROM People WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SQLServer.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Age, Income FROM dbo.People";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, global::System.Nullable<int> Original_Age, global::System.Nullable<double> Original_Income) {
        ...
        public virtual int Insert(string Name, global::System.Nullable<int> Age, global::System.Nullable<double> Income) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, global::System.Nullable<int> Age, global::System.Nullable<double> Income, int Original_Id, string Original_Name, global::System.Nullable<int> Original_Age, global::System.Nullable<double> Original_Income, int Id) {
            if ((Name == null)) {
            ...
            if ((Original_Income.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((double)(Original_Income.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, global::System.Nullable<int> Age, global::System.Nullable<double> Income, int Original_Id, string Original_Name, global::System.Nullable<int> Original_Age, global::System.Nullable<double> Original_Income) {
            return this.Update(Name, Age, Income, Original_Id, Original_Name, Original_Age, Original_Income, Original_Id);
        }
    }
