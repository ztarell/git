...
public class FA2017LAB7_Employee_Tarell {
    ...
    public FA2017LAB7_Employee_Tarell(String fn, String ln, String i, String d, double s) {
        firstname = fn;
        lastname = ln;
        id = i;
        department = d;
    ...
    public FA2017LAB7_Employee_Tarell deepCopy() {
        FA2017LAB7_Employee_Tarell clone = new FA2017LAB7_Employee_Tarell(firstname, lastname, id, department, salary);
        return clone;
    }
